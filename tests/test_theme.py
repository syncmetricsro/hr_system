...
def test_theme_labels_are_translated(language, expected):
    with translation.override(language):
        assert (
            tuple(gettext(value) for value in ("Theme", "Light", "Dark", "System"))
            == expected
        )
...
def test_primary_theme_text_tokens_meet_wcag_aa_contrast():
    palettes = {
        "jober-light": (
            "#ffffff",
            ["#1b2430", "#5b6b7e", "#2557a7", "#047857", "#b45309", "#b3261e"],
        ),
        "jober-dark": (
            "#211e2b",
            ["#f7f3ff", "#b5acbf", "#c4a7ff", "#65d6ad", "#ffc56d", "#ff7c8f"],
        ),
        "corvinum-light": (
            "#ffffff",
            ["#071e27", "#596675", "#005bbf", "#007a58", "#805b00", "#ba1a1a"],
        ),
        # Composite of the translucent Corvinum panel over its dark surface.
        "corvinum-dark": (
            "#0b1220",
            ["#e2e8f0", "#94a3b8", "#4d9cff", "#00d091", "#fdbc13", "#fb5b63"],
        ),
    }
    failures = {
