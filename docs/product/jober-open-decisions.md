...
| Offer emails: sender address | Jober `noreply@` address for outbound offer emails. | **Staging workaround supplied 2026-08-08:** SyncMetric's `test@syncmetric.sk` mailbox over Forpsi implicit SSL is authorized for fictional-data testing only. A Jober-owned production sender remains open. |
