...
| C-Q6 | Financial boundary sign-off (§13.1) — ledger is operational cash tracking, not payroll/accounting | Built as tracking only; no payroll export | Client (written) |
