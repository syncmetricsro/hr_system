...
app_routes += [
    ...
    # Recording a medical is not part of the activation workflow and must stay
    # reachable after it: the certificate expires annually.
    path(
        "people/<int:person_pk>/medical/",
        project_views.medical_record,
        name="medical_record",
    ),
